...
function joinClass(...classnames: string[]) {
...
const Enter: NextPage = () => {
  ...
  return (
    <div className="mt-16 px-10">
      <h3 className="text-3xl font-bold text-center">Enter to Narrot</h3>
      <div className="mt-8">
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative -top-3 text-center">
              <span className=" bg-white px-4 text-gray-700">
                Or enter with
              </span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white font-medium text-gray-400 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
